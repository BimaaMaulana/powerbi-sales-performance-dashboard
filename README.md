...
**[▶ Buka dashboard interaktif di Power BI](GANTI_DENGAN_LINK_PUBLISH_TO_WEB)**

> Coba langsung klik slicer tanggal, kategori, atau region di dashboard — semua chart akan ter-filter otomatis (cross-filtering).
...
2. Buka `dashboard/Sales_Performance_Dashboard.pbix` dengan [Power BI Desktop](https://powerbi.microsoft.com/desktop/) (gratis)
